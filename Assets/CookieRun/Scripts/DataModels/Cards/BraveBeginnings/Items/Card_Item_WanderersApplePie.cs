...
public class Card_Item_WanderersApplePie : Card_Item
{
    ...
    public Card_Item_WanderersApplePie()
    {
        Debug.Log("Card_Item_WanderersApplePie::Card_Item_WanderersApplePie");
        CardAbility cardAbility01 = new CardAbility();
    }

    public override void ActivateAbility(AbilityContextData abilityContext)
    {
        Debug.Log("Card_Item_WanderersApplePie::ActivateAbility");
