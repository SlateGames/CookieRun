...
public class Card_Item_JelliedJellyfishPotion : Card_Item
{
    ...
    public Card_Item_JelliedJellyfishPotion()
    {
        Debug.Log("Card_Item_JelliedJellyfishPotion::Card_Item_JelliedJellyfishPotion");
        CardAbility cardAbility01 = new CardAbility();
    }

    public override void ActivateAbility(AbilityContextData abilityContext)
    {
        Debug.Log("Card_Item_JelliedJellyfishPotion::ActivateAbility");
