...
public class JelliedJellyfishPotion : Card_Item
{
    ...
    public JelliedJellyfishPotion()
    {
        Debug.Log("JelliedJellyfishPotion::JelliedJellyfishPotion");
        CardAbility cardAbility01 = new CardAbility();
    }

    public override void ActivateAbility(AbilityContextData abilityContext)
    {
        Debug.Log("JelliedJellyfishPotion::ActivateAbility");
