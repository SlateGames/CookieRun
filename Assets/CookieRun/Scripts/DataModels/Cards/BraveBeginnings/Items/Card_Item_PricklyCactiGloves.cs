...
public class Card_Item_PricklyCactiGloves : Card_Item
{
    ...
    public Card_Item_PricklyCactiGloves()
    {
        Debug.Log("Card_Item_PricklyCactiGloves::Card_Item_PricklyCactiGloves");
        CardAbility cardAbility01 = new CardAbility();
    }

    public override void ActivateAbility(AbilityContextData abilityContext)
    {
        Debug.Log("Card_Item_PricklyCactiGloves::ActivateAbility");
