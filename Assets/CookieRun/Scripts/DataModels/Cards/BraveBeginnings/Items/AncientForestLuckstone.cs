...
public class AncientForestLuckstone : Card_Item
{
    ...
    public AncientForestLuckstone()
    {
        Debug.Log("AncientForestLuckstone::AncientForestLuckstone");
    ...
    {
        Debug.Log("AncientForestLuckstone::ActivateAbility");
