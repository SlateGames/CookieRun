...
public class Card_Item_JellyPomPoms : Card_Item
{
    ...
    public override string ImageName => "BS1_048.png";

    public Card_Item_JellyPomPoms()
    {
        Debug.Log("Card_Item_JellyPomPoms::Card_Item_JellyPomPoms");
        CardAbility cardAbility01 = new CardAbility();
    }

    public override void ActivateAbility(AbilityContextData abilityContext)
    {
        Debug.Log("Card_Item_JellyPomPoms::ActivateAbility");
