...
public class Card_Trap_AbandonedCloudNest : Card_Trap
{
    ...
    public Card_Trap_AbandonedCloudNest()
    {
        Debug.Log("Card_Trap_AbandonedCloudNest::Card_Trap_AbandonedCloudNest");
        CardAbility cardAbility01 = new CardAbility();
    }

    public override void ActivateAbility(AbilityContextData abilityContext)
    {
        Debug.Log("Card_Trap_AbandonedCloudNest::ActivateAbility");
