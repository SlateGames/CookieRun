...
public class Card_Trap_ErraticYakgwaRobot : Card_Trap
{
    ...
    public Card_Trap_ErraticYakgwaRobot()
    {
        Debug.Log("Card_Trap_ErraticYakgwaRobot::Card_Trap_ErraticYakgwaRobot");
        CardAbility cardAbility01 = new CardAbility();
    }

    public override void ActivateAbility(AbilityContextData abilityContext)
    {
        Debug.Log("Card_Trap_ErraticYakgwaRobot::ActivateAbility");
