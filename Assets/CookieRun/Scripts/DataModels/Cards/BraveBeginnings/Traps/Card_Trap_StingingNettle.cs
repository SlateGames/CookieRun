...
public class Card_Trap_StingingNettle : Card_Trap
{
    ...
    public override string ImageName => "BS1_076.png";

    public Card_Trap_StingingNettle()
    {
        Debug.Log("Card_Trap_StingingNettle::Card_Trap_StingingNettle");
        CardAbility cardAbility01 = new CardAbility();
    }

    public override void ActivateAbility(AbilityContextData abilityContext)
    {
        Debug.Log("Card_Trap_StingingNettle::ActivateAbility");
