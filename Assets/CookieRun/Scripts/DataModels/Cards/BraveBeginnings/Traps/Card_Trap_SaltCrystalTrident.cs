...
public class Card_Trap_SaltCrystalTrident : Card_Trap
{
    ...
    public Card_Trap_SaltCrystalTrident()
    {
        Debug.Log("Card_Trap_SaltCrystalTrident::Card_Trap_SaltCrystalTrident");
        CardAbility cardAbility01 = new CardAbility();
    }

    public override void ActivateAbility(AbilityContextData abilityContext)
    {
        Debug.Log("Card_Trap_SaltCrystalTrident::ActivateAbility");
