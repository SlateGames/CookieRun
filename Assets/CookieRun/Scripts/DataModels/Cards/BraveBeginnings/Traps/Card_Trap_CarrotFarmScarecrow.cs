...
public class Card_Trap_CarrotFarmScarecrow : Card_Trap
{
    ...
    public Card_Trap_CarrotFarmScarecrow()
    {
        Debug.Log("Card_Trap_CarrotFarmScarecrow::Card_Trap_CarrotFarmScarecrow");
        CardAbility cardAbility01 = new CardAbility();
    }

    public override void ActivateAbility(AbilityContextData abilityContext)
    {
        Debug.Log("Card_Trap_CarrotFarmScarecrow::ActivateAbility");
