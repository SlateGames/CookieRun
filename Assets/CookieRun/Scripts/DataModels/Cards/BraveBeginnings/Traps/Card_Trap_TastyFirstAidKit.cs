...
public class Card_Trap_TastyFirstAidKit : Card_Trap
{
    ...
    public override string ImageName => "BS1_077.png";

    public Card_Trap_TastyFirstAidKit()
    {
        Debug.Log("Card_Trap_TastyFirstAidKit::Card_Trap_TastyFirstAidKit");
        CardAbility cardAbility01 = new CardAbility();
    }

    public override void ActivateAbility(AbilityContextData abilityContext)
    {
        Debug.Log("Card_Trap_TastyFirstAidKit::ActivateAbility");
