...
public class AbandonedCloudNest : Card_Trap
{
    ...
    public AbandonedCloudNest()
    {
        Debug.Log("AbandonedCloudNest::AbandonedCloudNest");
        CardAbility cardAbility01 = new CardAbility();
    }

    public override void ActivateAbility(AbilityContextData abilityContext)
    {
        Debug.Log("AbandonedCloudNest::ActivateAbility");
