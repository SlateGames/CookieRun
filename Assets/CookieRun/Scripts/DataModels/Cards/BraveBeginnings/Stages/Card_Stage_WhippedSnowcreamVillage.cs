...
public class Card_Stage_WhippedSnowcreamVillage : Card_Stage
{
    ...
    public Card_Stage_WhippedSnowcreamVillage()
    {
        Debug.Log("Card_Stage_WhippedSnowcreamVillage::Card_Stage_WhippedSnowcreamVillage");
    ...
    {
        Debug.Log("Card_Stage_WhippedSnowcreamVillage::ActivateAbility");
