...
public class Card_Stage_AwakeningAncientForest : Card_Stage
{
    ...
    public Card_Stage_AwakeningAncientForest()
    {
        Debug.Log("Card_Stage_AwakeningAncientForest::Card_Stage_AwakeningAncientForest");
    ...
    {
        Debug.Log("Card_Stage_AwakeningAncientForest::ActivateAbility");
