...
public class WhippedSnowcreamVillage : Card_Stage
{
    ...
    public WhippedSnowcreamVillage()
    {
        Debug.Log("WhippedSnowcreamVillage::WhippedSnowcreamVillage");
    ...
    {
        Debug.Log("WhippedSnowcreamVillage::ActivateAbility");
