...
public class Card_Cookie_MintChocoCookie : Card_Cookie
{
    ...
    public Card_Cookie_MintChocoCookie()
    {
        Debug.Log("Card_Cookie_MintChocoCookie::Card_Cookie_MintChocoCookie");
    ...
    {
        Debug.Log("Card_Cookie_MintChocoCookie::ActivateAbility");
