...
public class Card_Cookie_TwizzlyGummyCookie : Card_Cookie
{
    ...
    public Card_Cookie_TwizzlyGummyCookie()
    {
        Debug.Log("Card_Cookie_TwizzlyGummyCookie::Card_Cookie_TwizzlyGummyCookie");
    ...
    {
        Debug.Log("Card_Cookie_TwizzlyGummyCookie::ActivateAbility");
