...
public class Card_Cookie_GrapefruitCookie : Card_Cookie
{
    ...
    public Card_Cookie_GrapefruitCookie()
    {
        Debug.Log("Card_Cookie_GrapefruitCookie::Card_Cookie_GrapefruitCookie");
    ...
    {
        Debug.Log("Card_Cookie_GrapefruitCookie::ActivateAbility");
