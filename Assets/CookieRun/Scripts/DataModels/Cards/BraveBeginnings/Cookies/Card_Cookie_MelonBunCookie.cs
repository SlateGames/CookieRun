...
public class Card_Cookie_MelonBunCookie : Card_Cookie
{
    ...
    public override string ImageName => "BS1_007.png";
    public override int CardHealth => 4;
    public override int CardLevel => 1;

    public Card_Cookie_MelonBunCookie()
    {
        Debug.Log("Card_Cookie_MelonBunCookie::Card_Cookie_MelonBunCookie");
        CardAbility cardAbility01 = new CardAbility();
    }

    public override void ActivateAbility(AbilityContextData abilityContext)
    {
        Debug.Log("Card_Cookie_MelonBunCookie::ActivateAbility");
