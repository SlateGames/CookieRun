...
public class Card_Cookie_SeaFairyCookie : Card_Cookie
{
    ...
    public override string ImageName => "BS2_029.png";
    public override int CardHealth => 5;
    public override int CardLevel => 3;

    public Card_Cookie_SeaFairyCookie()
    {
        Debug.Log("Card_Cookie_SeaFairyCookie::Card_Cookie_SeaFairyCookie");
    ...
    {
        Debug.Log("Card_Cookie_SeaFairyCookie::ActivateAbility");
