...
public class Card_Cookie_FrostQueenCookie : Card_Cookie
{
    ...
    public override string ImageName => "BS2_034.png";
    public override int CardHealth => 3;
    public override int CardLevel => 3;

    public Card_Cookie_FrostQueenCookie()
    {
        Debug.Log("Card_Cookie_FrostQueenCookie::Card_Cookie_FrostQueenCookie");
        CardAbility cardAbility01 = new CardAbility();
    }

    public override void ActivateAbility(AbilityContextData abilityContext)
    {
        Debug.Log("Card_Cookie_FrostQueenCookie::ActivateAbility");
