...
public class Card_Cookie_TeaKnightCookie : Card_Cookie
{
    ...
    public Card_Cookie_TeaKnightCookie()
    {
        Debug.Log("Card_Cookie_TeaKnightCookie::Card_Cookie_TeaKnightCookie");
    ...
    {
        Debug.Log("Card_Cookie_TeaKnightCookie::ActivateAbility");
