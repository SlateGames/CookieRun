...
public class Card_Cookie_PurpleYamCookie : Card_Cookie
{
    ...
    public Card_Cookie_PurpleYamCookie()
    {
        Debug.Log("Card_Cookie_PurpleYamCookie::Card_Cookie_PurpleYamCookie");
    ...
    {
        Debug.Log("Card_Cookie_PurpleYamCookie::ActivateAbility");
