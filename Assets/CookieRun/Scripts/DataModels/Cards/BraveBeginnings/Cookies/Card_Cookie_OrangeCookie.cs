...
public class Card_Cookie_OrangeCookie : Card_Cookie
{
    ...
    public override string ImageName => "BS1_041.png";
    public override int CardHealth => 1;
    public override int CardLevel => 1;

    public Card_Cookie_OrangeCookie()
    {
        Debug.Log("Card_Cookie_OrangeCookie::Card_Cookie_OrangeCookie");
    ...
    {
        Debug.Log("Card_Cookie_OrangeCookie::ActivateAbility");
