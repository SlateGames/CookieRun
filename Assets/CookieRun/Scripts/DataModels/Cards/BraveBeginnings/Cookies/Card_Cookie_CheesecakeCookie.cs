...
public class Card_Cookie_CheesecakeCookie : Card_Cookie
{
    ...
    public override string ImageName => "BS1_043.png";
    public override int CardHealth => 2;
    public override int CardLevel => 2;

    public Card_Cookie_CheesecakeCookie()
    {
        Debug.Log("Card_Cookie_CheesecakeCookie::Card_Cookie_CheesecakeCookie");
        CardAbility cardAbility01 = new CardAbility();
    }

    public override void ActivateAbility(AbilityContextData abilityContext)
    {
        Debug.Log("Card_Cookie_CheesecakeCookie::ActivateAbility");
