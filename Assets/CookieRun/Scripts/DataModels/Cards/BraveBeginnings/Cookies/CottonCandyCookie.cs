...
public class CottonCandyCookie : Card_Cookie
{
    ...
    public CottonCandyCookie()
    {
        Debug.Log("CottonCandyCookie::CottonCandyCookie");
    ...
    {
        Debug.Log("CottonCandyCookie::ActivateAbility");
