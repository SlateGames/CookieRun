...
public class Card_Cookie_DevilCookie : Card_Cookie
{
    ...
    public override string ImageName => "BS1_010.png";
    public override int CardHealth => 2;
    public override int CardLevel => 2;

    public Card_Cookie_DevilCookie()
    {
        Debug.Log("Card_Cookie_DevilCookie::Card_Cookie_DevilCookie");
        CardAbility cardAbility01 = new CardAbility();
    }

    public override void ActivateAbility(AbilityContextData abilityContext)
    {
        Debug.Log("Card_Cookie_DevilCookie::ActivateAbility");
