...
public class Card_Cookie_ButterbearCookie : Card_Cookie
{
    ...
    public Card_Cookie_ButterbearCookie()
    {
        Debug.Log("Card_Cookie_ButterbearCookie::Card_Cookie_ButterbearCookie");
        CardAbility cardAbility01 = new CardAbility();
    }

    public override void ActivateAbility(AbilityContextData abilityContext)
    {
        Debug.Log("Card_Cookie_ButterbearCookie::ActivateAbility");
