...
public class Card_Cookie_MangoCookie : Card_Cookie
{
    ...
    public Card_Cookie_MangoCookie()
    {
        Debug.Log("Card_Cookie_MangoCookie::Card_Cookie_MangoCookie");
        CardAbility cardAbility01 = new CardAbility();
    }

    public override void ActivateAbility(AbilityContextData abilityContext)
    {
        Debug.Log("Card_Cookie_MangoCookie::ActivateAbility");
