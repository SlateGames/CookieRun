...
public class PeperoncinoCookie : Card_Cookie
{
    ...
    public PeperoncinoCookie()
    {
        Debug.Log("PeperoncinoCookie::PeperoncinoCookie");
        CardAbility cardAbility01 = new CardAbility();
    }

    public override void ActivateAbility(AbilityContextData abilityContext)
    {
        Debug.Log("PeperoncinoCookie::ActivateAbility");
