...
public class Card_Cookie_BlackberryCookie : Card_Cookie
{
    ...
    public Card_Cookie_BlackberryCookie()
    {
        Debug.Log("Card_Cookie_BlackberryCookie::Card_Cookie_BlackberryCookie");
    ...
    {
        Debug.Log("Card_Cookie_BlackberryCookie::ActivateAbility");
