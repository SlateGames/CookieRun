...
public class Card_Cookie_GingerBrave : Card_Cookie
{
    ...
    public Card_Cookie_GingerBrave()
    {
        Debug.Log("Card_Cookie_GingerBrave::Card_Cookie_GingerBrave");
    ...
    {
        Debug.Log("Card_Cookie_GingerBrave::ActivateAbility");
