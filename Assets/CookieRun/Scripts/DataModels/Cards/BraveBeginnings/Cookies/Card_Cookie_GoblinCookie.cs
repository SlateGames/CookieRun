...
public class Card_Cookie_GoblinCookie : Card_Cookie
{
    ...
    public Card_Cookie_GoblinCookie()
    {
        Debug.Log("Card_Cookie_GoblinCookie::Card_Cookie_GoblinCookie");
    ...
    {
        Debug.Log("Card_Cookie_GoblinCookie::ActivateAbility");
