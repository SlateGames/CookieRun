...
public class Card_Cookie_HydrangeaCookie : Card_Cookie
{
    ...
    public Card_Cookie_HydrangeaCookie()
    {
        Debug.Log("Card_Cookie_HydrangeaCookie::Card_Cookie_HydrangeaCookie");
        CardAbility cardAbility01 = new CardAbility();
    }

    public override void ActivateAbility(AbilityContextData abilityContext)
    {
        Debug.Log("Card_Cookie_HydrangeaCookie::ActivateAbility");
