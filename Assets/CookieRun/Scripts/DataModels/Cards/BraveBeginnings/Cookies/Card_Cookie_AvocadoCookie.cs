...
public class Card_Cookie_AvocadoCookie : Card_Cookie
{
    ...
    public override string ImageName => "BS2_039.png";
    public override int CardHealth => 2;
    public override int CardLevel => 2;

    public Card_Cookie_AvocadoCookie()
    {
        Debug.Log("Card_Cookie_AvocadoCookie::Card_Cookie_AvocadoCookie");
    ...
    {
        Debug.Log("Card_Cookie_AvocadoCookie::ActivateAbility");
