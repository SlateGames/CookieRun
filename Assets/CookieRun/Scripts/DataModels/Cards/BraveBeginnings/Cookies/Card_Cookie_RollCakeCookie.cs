...
public class Card_Cookie_RollCakeCookie : Card_Cookie
{
    ...
    public override string ImageName => "BS1_005.png";
    public override int CardHealth => 2;
    public override int CardLevel => 2;

    public Card_Cookie_RollCakeCookie()
    {
        Debug.Log("Card_Cookie_RollCakeCookie::Card_Cookie_RollCakeCookie");
        CardAbility cardAbility01 = new CardAbility();
    }

    public override void ActivateAbility(AbilityContextData abilityContext)
    {
        Debug.Log("Card_Cookie_RollCakeCookie::ActivateAbility");
