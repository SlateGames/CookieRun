...
public class ChocolateBonbonCookie : Card_Cookie
{
    ...
    public ChocolateBonbonCookie()
    {
        Debug.Log("ChocolateBonbonCookie::ChocolateBonbonCookie");
        CardAbility cardAbility01 = new CardAbility();
    }

    public override void ActivateAbility(AbilityContextData abilityContext)
    {
        Debug.Log("ChocolateBonbonCookie::ActivateAbility");
