...
public class Card_Cookie_WildberryCookie : Card_Cookie
{
    ...
    public Card_Cookie_WildberryCookie()
    {
        Debug.Log("Card_Cookie_WildberryCookie::Card_Cookie_WildberryCookie");
        CardAbility cardAbility01 = new CardAbility();
    }

    public override void ActivateAbility(AbilityContextData abilityContext)
    {
        Debug.Log("Card_Cookie_WildberryCookie::ActivateAbility");
