...
public class Card_Cookie_MalaSauceCookie : Card_Cookie
{
    ...
    public Card_Cookie_MalaSauceCookie()
    {
        Debug.Log("Card_Cookie_MalaSauceCookie::Card_Cookie_MalaSauceCookie");
        CardAbility cardAbility01 = new CardAbility();
    }

    public override void ActivateAbility(AbilityContextData abilityContext)
    {
        Debug.Log("Card_Cookie_MalaSauceCookie::ActivateAbility");
