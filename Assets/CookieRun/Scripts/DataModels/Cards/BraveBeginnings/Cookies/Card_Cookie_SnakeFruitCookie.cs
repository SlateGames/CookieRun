...
public class Card_Cookie_SnakeFruitCookie : Card_Cookie
{
    ...
    public override string ImageName => "BS1_036.png";
    public override int CardHealth => 4;
    public override int CardLevel => 2;

    public Card_Cookie_SnakeFruitCookie()
    {
        Debug.Log("Card_Cookie_SnakeFruitCookie::Card_Cookie_SnakeFruitCookie");
    ...
    {
        Debug.Log("Card_Cookie_SnakeFruitCookie::ActivateAbility");
