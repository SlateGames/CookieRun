...
public class CauliflowerCookie : Card_Cookie
{
    ...
    public CauliflowerCookie()
    {
        Debug.Log("CauliflowerCookie::CauliflowerCookie");
    ...
    {
        Debug.Log("CauliflowerCookie::ActivateAbility");
