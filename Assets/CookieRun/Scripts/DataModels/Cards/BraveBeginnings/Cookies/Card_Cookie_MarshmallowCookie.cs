...
public class Card_Cookie_MarshmallowCookie : Card_Cookie
{
    ...
    public Card_Cookie_MarshmallowCookie()
    {
        Debug.Log("Card_Cookie_MarshmallowCookie::Card_Cookie_MarshmallowCookie");
    ...
    {
        Debug.Log("Card_Cookie_MarshmallowCookie::ActivateAbility");
