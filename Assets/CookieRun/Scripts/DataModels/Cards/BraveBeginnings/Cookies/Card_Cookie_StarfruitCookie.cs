...
public class Card_Cookie_StarfruitCookie : Card_Cookie
{
    ...
    public Card_Cookie_StarfruitCookie()
    {
        Debug.Log("Card_Cookie_StarfruitCookie::Card_Cookie_StarfruitCookie");
    ...
    {
        Debug.Log("Card_Cookie_StarfruitCookie::ActivateAbility");
