...
public class Card_Cookie_AngelCookie : Card_Cookie
{
    ...
    public override string ImageName => "BS2_067.png";
    public override int CardHealth => 3;
    public override int CardLevel => 1;

    public Card_Cookie_AngelCookie()
    {
        Debug.Log("Card_Cookie_AngelCookie::Card_Cookie_AngelCookie");
    ...
    {
        Debug.Log("Card_Cookie_AngelCookie::ActivateAbility");
