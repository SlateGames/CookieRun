...
public class Card_Cookie_PinkChocoCookie : Card_Cookie
{
    ...
    public Card_Cookie_PinkChocoCookie()
    {
        Debug.Log("Card_Cookie_PinkChocoCookie::Card_Cookie_PinkChocoCookie");
        CardAbility cardAbility01 = new CardAbility();
    }

    public override void ActivateAbility(AbilityContextData abilityContext)
    {
        Debug.Log("Card_Cookie_PinkChocoCookie::ActivateAbility");
