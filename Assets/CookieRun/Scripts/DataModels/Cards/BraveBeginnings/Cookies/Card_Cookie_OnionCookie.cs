...
public class Card_Cookie_OnionCookie : Card_Cookie
{
    ...
    public override string ImageName => "BS2_012.png";
    public override int CardHealth => 3;
    public override int CardLevel => 1;

    public Card_Cookie_OnionCookie()
    {
        Debug.Log("Card_Cookie_OnionCookie::Card_Cookie_OnionCookie");
    ...
    {
        Debug.Log("Card_Cookie_OnionCookie::ActivateAbility");
