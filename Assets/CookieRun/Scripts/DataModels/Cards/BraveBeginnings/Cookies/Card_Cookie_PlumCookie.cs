...
public class Card_Cookie_PlumCookie : Card_Cookie
{
    ...
    public Card_Cookie_PlumCookie()
    {
        Debug.Log("Card_Cookie_PlumCookie::Card_Cookie_PlumCookie");
        CardAbility cardAbility01 = new CardAbility();
    }

    public override void ActivateAbility(AbilityContextData abilityContext)
    {
        Debug.Log("Card_Cookie_PlumCookie::ActivateAbility");
