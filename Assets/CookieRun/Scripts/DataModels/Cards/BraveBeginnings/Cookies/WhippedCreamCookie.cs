...
public class WhippedCreamCookie : Card_Cookie
{
    ...
    public WhippedCreamCookie()
    {
        Debug.Log("WhippedCreamCookie::WhippedCreamCookie");
        CardAbility cardAbility01 = new CardAbility();
    }

    public override void ActivateAbility(AbilityContextData abilityContext)
    {
        Debug.Log("WhippedCreamCookie::ActivateAbility");
