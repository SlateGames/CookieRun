...
public class Card_Cookie_BellPepperCookie : Card_Cookie
{
    ...
    public Card_Cookie_BellPepperCookie()
    {
        Debug.Log("Card_Cookie_BellPepperCookie::Card_Cookie_BellPepperCookie");
    ...
    {
        Debug.Log("Card_Cookie_BellPepperCookie::ActivateAbility");
