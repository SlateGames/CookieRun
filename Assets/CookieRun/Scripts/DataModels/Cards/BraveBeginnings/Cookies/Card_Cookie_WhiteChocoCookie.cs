...
public class Card_Cookie_WhiteChocoCookie : Card_Cookie
{
    ...
    public override string ImageName => "BS2_075.png";
    public override int CardHealth => 3;
    public override int CardLevel => 2;

    public Card_Cookie_WhiteChocoCookie()
    {
        Debug.Log("Card_Cookie_WhiteChocoCookie::Card_Cookie_WhiteChocoCookie");
    ...
    {
        Debug.Log("Card_Cookie_WhiteChocoCookie::ActivateAbility");
