...
public class Card_Cookie_IceJugglerCookie : Card_Cookie
{
    ...
    public Card_Cookie_IceJugglerCookie()
    {
        Debug.Log("Card_Cookie_IceJugglerCookie::Card_Cookie_IceJugglerCookie");
        CardAbility cardAbility01 = new CardAbility();
    }

    public override void ActivateAbility(AbilityContextData abilityContext)
    {
        Debug.Log("Card_Cookie_IceJugglerCookie::ActivateAbility");
