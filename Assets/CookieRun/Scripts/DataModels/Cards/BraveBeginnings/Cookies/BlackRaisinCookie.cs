...
public class BlackRaisinCookie : Card_Cookie
{
    ...
    public BlackRaisinCookie()
    {
        Debug.Log("BlackRaisinCookie::BlackRaisinCookie");
    ...
    {
        Debug.Log("BlackRaisinCookie::ActivateAbility");
