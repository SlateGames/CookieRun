...
public class Card_Cookie_LemonThymeCookie : Card_Cookie
{
    ...
    public Card_Cookie_LemonThymeCookie()
    {
        Debug.Log("Card_Cookie_LemonThymeCookie::Card_Cookie_LemonThymeCookie");
    ...
    {
        Debug.Log("Card_Cookie_LemonThymeCookie::ActivateAbility");
