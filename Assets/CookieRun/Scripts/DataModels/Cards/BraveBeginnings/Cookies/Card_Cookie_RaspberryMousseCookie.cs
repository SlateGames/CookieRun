...
public class Card_Cookie_RaspberryMousseCookie : Card_Cookie
{
    ...
    public Card_Cookie_RaspberryMousseCookie()
    {
        Debug.Log("Card_Cookie_RaspberryMousseCookie::Card_Cookie_RaspberryMousseCookie");
    ...
    {
        Debug.Log("Card_Cookie_RaspberryMousseCookie::ActivateAbility");
