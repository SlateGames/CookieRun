...
public class CaramelArrowCookie : Card_Cookie
{
    ...
    public CaramelArrowCookie()
    {
        Debug.Log("CaramelArrowCookie::CaramelArrowCookie");
    ...
    {
        Debug.Log("CaramelArrowCookie::ActivateAbility");
