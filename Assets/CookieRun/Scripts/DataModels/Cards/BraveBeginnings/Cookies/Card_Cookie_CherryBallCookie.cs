...
public class Card_Cookie_CherryBallCookie : Card_Cookie
{
    ...
    public Card_Cookie_CherryBallCookie()
    {
        Debug.Log("Card_Cookie_CherryBallCookie::Card_Cookie_CherryBallCookie");
        CardAbility cardAbility01 = new CardAbility();
    }

    public override void ActivateAbility(AbilityContextData abilityContext)
    {
        Debug.Log("Card_Cookie_CherryBallCookie::ActivateAbility");
