...
public class Card_Cookie_PomegranateCookie : Card_Cookie
{
    ...
    public Card_Cookie_PomegranateCookie()
    {
        Debug.Log("Card_Cookie_PomegranateCookie::Card_Cookie_PomegranateCookie");
    ...
    {
        Debug.Log("Card_Cookie_PomegranateCookie::ActivateAbility");
