...
public class Card_Cookie_AloeCookie : Card_Cookie
{
    ...
    public override string ImageName => "BS2_040.png";
    public override int CardHealth => 2;
    public override int CardLevel => 1;

    public Card_Cookie_AloeCookie()
    {
        Debug.Log("Card_Cookie_AloeCookie::Card_Cookie_AloeCookie");
        CardAbility cardAbility01 = new CardAbility();
    }

    public override void ActivateAbility(AbilityContextData abilityContext)
    {
        Debug.Log("Card_Cookie_AloeCookie::ActivateAbility");
