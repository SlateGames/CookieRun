...
public class Card_Cookie_CarrotCookie : Card_Cookie
{
    ...
    public Card_Cookie_CarrotCookie()
    {
        Debug.Log("Card_Cookie_CarrotCookie::Card_Cookie_CarrotCookie");
        CardAbility cardAbility01 = new CardAbility();
    }

    public override void ActivateAbility(AbilityContextData abilityContext)
    {
        Debug.Log("Card_Cookie_CarrotCookie::ActivateAbility");
