...
public class Card_Cookie_HerbCookie : Card_Cookie
{
    ...
    public Card_Cookie_HerbCookie()
    {
        Debug.Log("Card_Cookie_HerbCookie::Card_Cookie_HerbCookie");
    ...
    {
        Debug.Log("Card_Cookie_HerbCookie::ActivateAbility");
