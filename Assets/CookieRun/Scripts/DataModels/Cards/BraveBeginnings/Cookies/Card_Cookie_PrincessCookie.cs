...
public class Card_Cookie_PrincessCookie : Card_Cookie
{
    ...
    public override string ImageName => "BS2_008.png";
    public override int CardHealth => 2;
    public override int CardLevel => 1;

    public Card_Cookie_PrincessCookie()
    {
        Debug.Log("Card_Cookie_PrincessCookie::Card_Cookie_PrincessCookie");
        CardAbility cardAbility01 = new CardAbility();
    }

    public override void ActivateAbility(AbilityContextData abilityContext)
    {
        Debug.Log("Card_Cookie_PrincessCookie::ActivateAbility");
