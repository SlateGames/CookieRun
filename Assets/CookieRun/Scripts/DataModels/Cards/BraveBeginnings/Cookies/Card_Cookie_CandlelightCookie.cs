...
public class Card_Cookie_CandlelightCookie : Card_Cookie
{
    ...
    public Card_Cookie_CandlelightCookie()
    {
        Debug.Log("Card_Cookie_CandlelightCookie::Card_Cookie_CandlelightCookie");
    ...
    {
        Debug.Log("Card_Cookie_CandlelightCookie::ActivateAbility");
