...
public class Card_Cookie_FigCookie : Card_Cookie
{
    ...
    public Card_Cookie_FigCookie()
    {
        Debug.Log("Card_Cookie_FigCookie::Card_Cookie_FigCookie");
        CardAbility cardAbility01 = new CardAbility();
    }

    public override void ActivateAbility(AbilityContextData abilityContext)
    {
        Debug.Log("Card_Cookie_FigCookie::ActivateAbility");
