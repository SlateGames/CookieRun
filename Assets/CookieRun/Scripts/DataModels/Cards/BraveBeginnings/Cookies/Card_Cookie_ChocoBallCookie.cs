...
public class Card_Cookie_ChocoBallCookie : Card_Cookie
{
    ...
    public Card_Cookie_ChocoBallCookie()
    {
        Debug.Log("Card_Cookie_ChocoBallCookie::Card_Cookie_ChocoBallCookie");
        CardAbility cardAbility01 = new CardAbility();
    }

    public override void ActivateAbility(AbilityContextData abilityContext)
    {
        Debug.Log("Card_Cookie_ChocoBallCookie::ActivateAbility");
