...
public class CherryBlossomCookie : Card_Cookie
{
    ...
    public CherryBlossomCookie()
    {
        Debug.Log("CherryBlossomCookie::CherryBlossomCookie");
        CardAbility cardAbility01 = new CardAbility();
    }

    public override void ActivateAbility(AbilityContextData abilityContext)
    {
        Debug.Log("CherryBlossomCookie::ActivateAbility");
