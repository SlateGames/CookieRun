...
public class ClottedCreamCookie : Card_Cookie
{
    ...
    public ClottedCreamCookie()
    {
        Debug.Log("ClottedCreamCookie::ClottedCreamCookie");
    ...
    {
        Debug.Log("ClottedCreamCookie::ActivateAbility");
